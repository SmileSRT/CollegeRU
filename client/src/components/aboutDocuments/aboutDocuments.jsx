                ...
                <Col lg={8}>
                    ...
                    <div className={classes.header}>
                        <h4>Устав образовательной организации</h4>
                            ...
                            <div className={classes.urlStyle}>
                                <a href={process.env.REACT_APP_API_URL + '/pdf/founding_documents/Лист_Записи_Единого_Государственного_Реестра_Юридических_Лиц.pdf'}>Выписка из реестра лицензий от 04.05.2023г</a>
                            </div>
